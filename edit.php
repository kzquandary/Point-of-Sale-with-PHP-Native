        ...
        <div class="col-lg-14 mb-lg-0 mb-4">
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              <h6 class="text-capitalize">Edit Data Penjualan</h6>
            </div>
            <div class="card-body p-3">
              ...
              <div class="col-md-12">
                ...
                <form action="aksiedit.php" method="POST">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="id" value="<?php echo $data['id']; ?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Customer</label>
                    <input class="form-control" type="text" name="customer" value="<?php echo $data['customer']; ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="varian" value="<?php echo $data['varian'] ?>">
                  </div>
                  <div class="form-group">
