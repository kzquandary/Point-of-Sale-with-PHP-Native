...
<?php
include 'koneksi.php';
if (isset($_POST['customer']) && isset($_POST['qty']) && isset($_POST['harga']) && isset($_POST['varian']) && isset($_POST['tanggal']) && isset($_POST['status'])) {
    ...
    $query = "INSERT INTO sale (id, customer, qty, harga, varian, tanggal, status) VALUES (NULL,'$customer', '$qty', '$harga', '$varian', '$tanggal', '$status')";
  
    if (mysqli_query($con, $query)) {
        header('Location: index.php?pesanorder=Sukses');
    } else {
        header('Location: index.php?pesanorder=Gagal');
    }
  }
        ...
        <div class="col-lg-14 mb-lg-0 mb-4">
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              <h6 class="text-capitalize">Tambah Data Penjualan</h6>
            </div>
            <div class="card-body p-3">
              ...
              <div class="col-md-12">
                <form action="order.php" method="POST">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="customer" placeholder="Masukan Nama Customer">
                  </div>
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Qty</label>
                    <input class="form-control" type="number" name="qty" placeholder="Masukan Jumlah Barang">
                  </div>
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Harga</label>
                    <input class="form-control" type="number" name="harga" placeholder="Masukan Total Hargar">
                  </div>
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Varian</label>
                    <input class="form-control" type="text" name="varian" placeholder="Masukan Varian Order">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="status" name="status">
                        <option class="form-control"  value="Lunas">Lunas</option>
                        <option class="form-control"  value="Belum Lunas">Belum Lunas</option>
                    </select>
                  </div>
